 ...
 *
 * The title, then one container holding everything else: the product tabs, the
 * search/filter/Download row, and the table, exactly as SkuTable arranges the
 * same three parts. The step between the title and that container is spacing
 * alone (PageHeader's own bottom margin plus space-y-4), with no divider rule —
 * the title is the strongest element on the page, and the container is the one
 * surface that carries everything below it.
 */
