...
import { LinkInvoiceDialog } from "@/features/dashboard/mca-invoices/components/LinkInvoiceDialog";
 ...
 * rather than "pick one of three equal options" — the same shortcuts the
 * Transactions table's row-level "…" menu used to offer (see
 * McaTransactionTable's onCreateInvoice/onLinkInvoice), whose removal (see
 * columns.tsx) left this as their only remaining entry point.
 *
