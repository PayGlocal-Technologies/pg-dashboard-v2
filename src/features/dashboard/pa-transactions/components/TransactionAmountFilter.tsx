      ...
      <PopoverContent align="start" className="w-64 p-3">
        <div className="flex items-start gap-2">
          <Field className="flex-1">
            <FieldLabel htmlFor="txn-amount-min" className="text-[11px] text-muted-foreground">
              Min amount
            </FieldLabel>
            <Input
              id="txn-amount-min"
          ...
          <Field className="flex-1">
            <FieldLabel htmlFor="txn-amount-max" className="text-[11px] text-muted-foreground">
              Max amount
            </FieldLabel>
            <Input
              id="txn-amount-max"
