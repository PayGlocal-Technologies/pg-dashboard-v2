  ...
  return (
    <section>
      ...
      <DataTableCard<ClientInvoice>
        ...
        skeletonRows={5}
        // The title moves with the description: saying "No invoices yet" over a
        // status-filtered list claimed this client had never been invoiced, when
        // the merchant had simply narrowed the view.
        emptyTitle={
