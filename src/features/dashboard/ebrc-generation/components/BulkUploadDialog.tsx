...
export function BulkUploadDialog({
  ...
  const handleUpload = () => {
    ...
    // spec, not a guess. No per-row result to show yet either, so this ends
    // at the same "request received" pop-up the full wizard's own "Confirm
    // and generate" does, rather than a toast.
    close();
            ...
            <Button
              ...
              onClick={() =>
                toast.message("Template download isn't connected to the backend yet", {
                  description:
                    "This will export your open IRMs pre-filled into the upload template.",
                })
              }
            >
