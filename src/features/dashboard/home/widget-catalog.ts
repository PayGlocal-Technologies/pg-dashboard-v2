...
export type WidgetCategory =
  "Payments" | "Settlements" | "Customers" | "India & growth" | "Risk & Disputes" | "Charts";
...
export const WIDGET_CATALOG: WidgetCatalogEntry[] = [
  ...
  {
    id: "charts_upi_vs_card_weekly",
    name: "UPI vs Card (weekly)",
    category: "India & growth",
    iconName: "credit-card",
    lgColSpan: 7,
  },
  {
    id: "charts_net_vs_gross",
    name: "Net vs gross (after fees)",
    category: "Charts",
    iconName: "trending-up",
    lgColSpan: 6,
  },
  {
    id: "charts_inr_fx_split",
    name: "INR vs FX volume",
    category: "India & growth",
    iconName: "globe",
    lgColSpan: 4,
  },
  {
    id: "charts_settlement_lag",
    name: "Settlement speed (T+N)",
    category: "Settlements",
    iconName: "timer",
    lgColSpan: 5,
  },
  {
    id: "charts_decline_reasons",
  ...
  {
    id: "settlements_next_date",
    name: "Next Settlement Date",
    category: "Settlements",
    iconName: "activity",
    lgColSpan: 4,
  },
  {
    id: "customers_active_kpi",
