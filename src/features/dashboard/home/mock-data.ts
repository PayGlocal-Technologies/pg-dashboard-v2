  ...
  hourly: [
    {
      label: "00:00",
      grossL: 0.35,
      grossYesterdayL: 0.28,
      netL: 0.32,
      netYesterdayL: 0.26,
      payments: 48,
      paymentsYesterday: 41,
      payOk: 45,
      payFail: 2,
      payDisp: 1,
      payOkY: 38,
      payFailY: 2,
      payDispY: 1,
      payMixToday: [0.46, 0.28, 0.18, 0.08] as const,
      payMixYesterday: [0.44, 0.29, 0.19, 0.08] as const,
    },
    {
      label: "02:00",
      grossL: 0.22,
      ...
      payFailY: 1,
      payDispY: 1,
      payMixToday: [0.42, 0.3, 0.2, 0.08] as const,
      payMixYesterday: [0.45, 0.28, 0.19, 0.08] as const,
    },
    {
      label: "04:00",
      grossL: 0.18,
      grossYesterdayL: 0.15,
      netL: 0.16,
      netYesterdayL: 0.14,
      payments: 26,
      paymentsYesterday: 22,
      payOk: 24,
      payFail: 2,
      payDisp: 0,
      payOkY: 20,
      payFailY: 2,
      payDispY: 0,
      payMixToday: [0.4, 0.32, 0.2, 0.08] as const,
      payMixYesterday: [0.43, 0.3, 0.19, 0.08] as const,
    },
    {
      label: "06:00",
      grossL: 0.45,
      grossYesterdayL: 0.38,
      netL: 0.42,
      netYesterdayL: 0.35,
      payments: 58,
      paymentsYesterday: 51,
      payOk: 55,
      payFail: 2,
      payDisp: 1,
      payOkY: 48,
      payFailY: 2,
      payDispY: 1,
      payMixToday: [0.44, 0.29, 0.19, 0.08] as const,
      payMixYesterday: [0.46, 0.27, 0.19, 0.08] as const,
    },
    {
      label: "08:00",
      grossL: 1.2,
      grossYesterdayL: 0.95,
      netL: 1.12,
      netYesterdayL: 0.88,
      payments: 142,
      paymentsYesterday: 118,
      payOk: 134,
      payFail: 6,
      payDisp: 2,
      payOkY: 112,
      payFailY: 4,
      payDispY: 2,
      payMixToday: [0.48, 0.27, 0.17, 0.08] as const,
      payMixYesterday: [0.45, 0.28, 0.19, 0.08] as const,
    },
    {
      label: "10:00",
      ...
      payFailY: 10,
      payDispY: 3,
      payMixToday: [0.5, 0.26, 0.16, 0.08] as const,
      payMixYesterday: [0.47, 0.27, 0.18, 0.08] as const,
    },
    {
      label: "12:00",
      grossL: 4.1,
      ...
      payFailY: 13,
      payDispY: 4,
      payMixToday: [0.49, 0.26, 0.17, 0.08] as const,
      payMixYesterday: [0.46, 0.28, 0.18, 0.08] as const,
    },
    {
      label: "14:00",
      grossL: 5.2,
      ...
      payFailY: 15,
      payDispY: 4,
      payMixToday: [0.47, 0.27, 0.18, 0.08] as const,
      payMixYesterday: [0.45, 0.29, 0.18, 0.08] as const,
    },
    {
      label: "16:00",
      grossL: 6.4,
    ...
    },
    {
      ...
      payFailY: 20,
      payDispY: 4,
      payMixToday: [0.45, 0.28, 0.19, 0.08] as const,
      payMixYesterday: [0.43, 0.3, 0.19, 0.08] as const,
    },
    {
      label: "20:00",
      ...
      payDispY: 5,
      payMixToday: [0.44, 0.29, 0.19, 0.08] as const,
      payMixYesterday: [0.42, 0.3, 0.2, 0.08] as const,
    },
    {
      label: "22:00",
      grossL: 9.2,
      grossYesterdayL: 8.45,
      netL: 8.64,
      netYesterdayL: 7.92,
      payments: 512,
      paymentsYesterday: 468,
      payOk: 482,
      payFail: 25,
      payDisp: 5,
      payOkY: 440,
      payFailY: 23,
      payDispY: 5,
      payMixToday: [0.43, 0.29, 0.2, 0.08] as const,
      payMixYesterday: [0.41, 0.31, 0.2, 0.08] as const,
    },
  ],
};
